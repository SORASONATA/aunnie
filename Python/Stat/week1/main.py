...
stat269_pset1.py file. Put that file and this file in the same 
directory.
...
from stat269_pset1 import play_game


def main():
    print('Your play_game function with default parameters returned', play_game(round))
